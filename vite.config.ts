...
export default defineConfig(({ command, mode }) => {
  ...
  return defineConfig({
    ...
    plugins: [
      ...
      // uview-plus doesn't need a custom resolver, it works with easycom
      {
        name: 'uview-plus-compat',
        configResolved(config) {
          // uview-plus compatibility plugin
        },
      },
      Uni(),
      {
    ...
    server: {
      ...
      allowedHosts: ['78f63426.r21.cpolar.top', 'localhost'],
