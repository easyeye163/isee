...
export default defineConfig({
    ...
    presetIcons({
      ...
      collections: {
        ...
        'my-icons': FileSystemIconLoader(
          ...
          (svg) => {
            // 添加错误处理，防止svg为undefined时出现错误
            if (!svg) {
              return '<svg fill="currentColor" width="1em" height="1em" viewBox="0 0 24 24"></svg>'
            }
        ...
        // 使用 Carbon 图标集合，提供简洁的系统风格图标，符合iOS设计规范
  ...
  safelist: ['i-carbon-code', 'i-carbon-home', 'i-carbon-user', 'i-carbon-shopping-cart', 'i-carbon-edit'],
  rules: [
    [
      'p-safe',
      {
